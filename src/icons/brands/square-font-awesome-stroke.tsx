...
export const SquareFontAwesomeStrokeIcon = forwardRef<SVGSVGElement, SVGAttributes<SVGSVGElement>>(
  ({ className, ...props }, ref) => (
...
SquareFontAwesomeStrokeIcon.displayName = 'SquareFontAwesomeStrokeIcon';
