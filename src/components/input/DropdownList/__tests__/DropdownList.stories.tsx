...
function DefaultDemo() {
  ...
  return <DropdownList data={{ options }} selection={{ value, onChange: setValue }} />;
}

function WithLabelDemo() {
  const [value, setValue] = useState<string | string[]>('');
  return <DropdownList data={{ options }} selection={{ value, onChange: setValue }} label="Choose an option" />;
}
...
function ErrorDemo() {
  const [value, setValue] = useState<string | string[]>('');
  return <DropdownList data={{ options }} selection={{ value, onChange: setValue }} error="Please select an option" />;
}
