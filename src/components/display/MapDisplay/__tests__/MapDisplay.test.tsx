...
describe('MapDisplay', () => {
  it('renders iframe when src provided', () => {
    render(<MapDisplay source={{ src: 'https://maps.example.com' }} />);
  ...
  it('renders markers when provided', () => {
    ...
    render(<MapDisplay state={{ markers }} />);
  ...
  it('toggles interactivity', () => {
    const { container: interactive } = render(
      <MapDisplay source={{ src: 'https://maps.example.com', interactive: true }} />,
    );
    expect(interactive.querySelector('iframe')).toBeInTheDocument();

    const { container: staticContainer } = render(
      <MapDisplay source={{ src: 'https://maps.example.com', interactive: false }} />,
    );
