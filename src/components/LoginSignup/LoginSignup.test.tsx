...
describe('LoginSignup', () => {
  ...
  it('calls onLogin with form data on submit', async () => {
    const onLogin = vi.fn();
    const user = userEvent.setup();
    render(<LoginSignup onLogin={onLogin} />);
  ...
  it('calls onSignup with form data on submit', async () => {
    ...
    const user = userEvent.setup();
    render(<LoginSignup defaultView="signup" onSignup={onSignup} />);
  ...
  it('calls onResetPassword on reset submit', async () => {
    ...
    const user = userEvent.setup();
    render(<LoginSignup onResetPassword={onResetPassword} />);
    await user.click(screen.getByRole('button', { name: 'Forgot password?' }));
  ...
  it('displays error message', () => {
    render(<LoginSignup error="Invalid credentials" />);
    expect(screen.getByRole('alert')).toHaveTextContent('Invalid credentials');
  });

  it('disables submit button when loading', () => {
    render(<LoginSignup loading />);
  ...
  it('renders provider buttons', () => {
    render(<LoginSignup providers={providers} />);
  ...
  it('calls onProviderAuth when clicking a provider', async () => {
    ...
    const user = userEvent.setup();
    render(
      <LoginSignup providers={providers} onProviderAuth={onProviderAuth} />,
    );
