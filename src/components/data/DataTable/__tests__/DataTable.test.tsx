...
describe('DataTable', () => {
  ...
  it('renders loading state', () => {
    render(<DataTable data={{ columns: DEFAULT_COLUMNS, data: [] }} loading />);
  ...
  it('renders title and actions area', () => {
    render(
      <DataTable
        data={{ columns: DEFAULT_COLUMNS, data: DEFAULT_DATA }}
        title="Users"
  ...
  it('renders custom cell content via render function', () => {
    ...
    render(<DataTable data={{ columns, data: DEFAULT_DATA.slice(0, 1) }} />);
  ...
  it('shows pagination with correct page info', () => {
    ...
    render(
      <DataTable
        data={{ columns: DEFAULT_COLUMNS, data: bigData }}
  ...
  it('filters by custom searchColumns', async () => {
    ...
    render(
      <DataTable
        data={{ columns, data: DEFAULT_DATA }}
  ...
  it('preserves correct original index in onEdit after sorting and filtering', async () => {
    ...
    render(
      <DataTable
        data={{ columns, data: DEFAULT_DATA, edit: { enabled: true, onEdit } }}
      />,
    );
  ...
  describe('virtualized', () => {
    it('uses custom virtualizedMaxHeight', () => {
      ...
      const { container } = render(
        <DataTable
          data={{ columns: DEFAULT_COLUMNS, data }}
          pagination={{ virtual: { enabled: true, maxHeight: 800 } }}
        />,
      );
  ...
  describe('virtualized', () => {
    ...
    it('does not enable virtualization when virtualizedThreshold not exceeded', () => {
      ...
      render(
        <DataTable
          data={{ columns: DEFAULT_COLUMNS, data }}
          pagination={{ virtual: { enabled: true, threshold: 200 } }}
        />,
      );
