...
export const COMPONENT_DATA = [
  {
    name: 'Alert',
    description:
      'A contextual notification banner with multiple severity levels, dismissible support, and auto-dismiss.',
    category: 'composite',
    features: [
    ...
    cssVars: [
      ...
      {
        name: '--azimuth-color-surface',
        description: 'Alert background color',
      },
      { name: '--azimuth-color-text', description: 'Alert text color' },
      {
        name: '--azimuth-color-text-secondary',
        description: 'Alert body text color',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    props: [
      ...
      },
      {
        ...
        type: 'boolean',
        default: 'false',
        description: 'Whether to render a square avatar',
      },
    ],
    cssVars: [
      { name: '--azimuth-color-primary', description: 'Initials text color' },
      {
        name: '--azimuth-color-primary-subtle',
  ...
  },
  {
    name: 'Badge',
    description:
      'A small status indicator label used to highlight counts or states.',
    category: 'composite',
    features: [
  ...
  },
  {
    name: 'Breadcrumbs',
    description:
      'A navigation trail showing the current page location within the site hierarchy.',
    category: 'composite',
    features: [
      'Collapsible with ellipsis when exceeding max items',
      'Customizable separator',
      'ARIA navigation landmark with current page indication',
    ],
    variants: [],
    props: [
      {
      ...
      },
      {
        ...
        type: 'string',
        default: '/',
        description: 'Custom separator string between items',
      },
      {
        name: 'maxItems',
        type: 'number',
    ...
    cssVars: [
      ...
      {
        name: '--azimuth-color-text-secondary',
        description: 'Inactive item color',
      },
    ],
  },
  {
    ...
    category: 'primitive',
    features: [
      'Multiple style variants including primary, secondary, tertiary, link, and danger',
      'Three sizes (sm, md, lg)',
      'Icon support with left/right positioning',
      'Icon-only mode with accessible label',
      'Full-width option',
      'Flat variant via theme',
    ],
    ...
    props: [
      ...
      },
      {
        name: 'icon',
        type: 'ReactNode',
        description: 'Optional icon element to display alongside the label',
      },
      {
        name: 'iconPosition',
        type: 'string',
        default: 'left',
        description: 'Where to position the icon relative to the label',
      },
      {
        name: 'fullWidth',
        type: 'boolean',
    ...
    cssVars: [
      {
        name: '--azimuth-color-primary',
        description: 'Primary button background',
      },
      {
        name: '--azimuth-color-on-primary',
  ...
  },
  {
    name: 'Calendar',
    description:
      'A full month-view date picker with navigation and keyboard support.',
    category: 'composite',
    features: [
      'Month navigation with prev/next buttons',
      'Controlled or uncontrolled value',
      'Date range limits via min/max date',
    ...
    props: [
      ...
      },
      {
        name: 'locale',
        type: 'string',
        description: 'Locale for formatting weekday names',
      },
    ],
    cssVars: [
      {
      ...
      {
        name: '--azimuth-color-surface-hover',
        description: 'Day hover background',
      },
    ],
  },
  {
    name: 'Card',
    description:
      'A content container with optional header, footer, and expandable body.',
    category: 'composite',
    features: [
      'Header and footer slots',
      'Collapsible/expandable body',
      'Subcomponents: Header, Footer, Title, Description, Content',
    ...
    props: [
      ...
      },
      {
        ...
        type: 'boolean',
        default: 'false',
        description: 'Whether the card body is collapsible',
      },
      {
  ...
  },
  {
    name: 'Carousel',
    description:
      'A slideshow component with auto-play, dot indicators, and arrow controls.',
    category: 'composite',
    features: [
      'Auto-play with configurable interval',
      'Dot indicators for slide navigation',
      'Arrow controls for prev/next',
      'Looping or non-looping modes',
      'Pauses on hover',
    ...
    props: [
      ...
      {
        name: 'autoplay',
        type: '{ enabled?: boolean; interval?: number }',
        default: '{ enabled: false, interval: 5000 }',
        description: 'Auto-advance behavior',
      },
      {
        name: 'showDots',
        type: 'boolean',
      ...
      },
      {
        ...
        type: 'boolean',
        default: 'true',
        description: 'Whether to show arrow controls',
      },
      {
        name: 'loop',
        type: 'boolean',
  ...
  },
  {
    ...
    category: 'composite',
    features: [
      'Message bubbles with user/other alignment',
    ...
    cssVars: [
      ...
      {
        name: '--azimuth-color-surface',
        description: 'Other message bubble background',
      },
  ...
  },
  {
    ...
    props: [
      ...
      },
      {
        name: 'children',
        type: 'ReactNode',
        description: 'Alternative label content',
      },
    ],
    cssVars: [
  ...
  },
  {
    name: 'Chip',
    description:
      'A compact element representing an input, filter, or selection with optional delete and avatar.',
    category: 'composite',
    features: [
      'Multiple color variants',
      'Two sizes (sm, md)',
      'Deletable with remove button',
      'Selectable with click handler',
      'Leading avatar/icon support',
    ],
    variants: ['neutral', 'accent', 'success', 'warning', 'danger', 'info'],
    props: [
      {
      ...
      },
      {
        name: 'avatar',
        type: 'ReactNode',
        description: 'Leading avatar or icon element',
      },
      {
        name: 'children',
        type: 'ReactNode',
  ...
  },
  {
    name: 'CodeBlock',
    description:
      'A syntax-highlighted code display block with copy button and line numbers.',
    category: 'composite',
    features: [
    ...
    props: [
      ...
      },
      {
        name: 'language',
        type: 'string',
        description: 'The programming language for labeling',
      },
      {
  ...
  },
  {
    ...
    props: [
      ...
      { name: 'data', type: 'T[]', description: 'Array of data rows' },
      {
        name: 'pageSize',
        type: 'number',
        description: 'Controlled page size for pagination',
      },
      {
        name: 'search',
        type: '{ enabled?: boolean; placeholder?: string; columns?: string[]; columnSelector?: boolean; onSearch?: (query: string) => void }',
        default: '{ enabled: false }',
        description: 'Search configuration for the table',
      },
      {
        name: 'loading',
        type: 'boolean',
      ...
      },
      {
        name: 'error',
        type: 'string',
        description: 'Error message string to display',
      },
      {
        name: 'editable',
        type: 'boolean',
        default: 'false',
        description: 'Whether rows have an edit action',
      },
      {
        name: 'onRowClick',
  ...
  },
  {
    ...
    description:
      'A date range selector with start/end inputs and inline calendar popups.',
    category: 'composite',
    features: [
      'Start and end date selection',
      'Inline calendar popups',
  ...
  },
  {
    name: 'DateTimePicker',
    description:
      'A combined date and time picker with a calendar and time selectors.',
    category: 'composite',
    features: [
    ...
    props: [
      {
        name: 'value',
        type: 'Date',
        description: 'The controlled selected date/time',
      },
      {
        name: 'defaultValue',
        type: 'Date',
        description: 'The default selected date/time (uncontrolled)',
      },
      {
        name: 'onChange',
        type: '(date: Date) => void',
  ...
  },
  {
    name: 'Dialog',
    description:
      'A modal confirmation dialog with title, description, variant styling, and action buttons.',
    category: 'composite',
    features: [
      'Confirm and cancel actions',
      'Info, warning, and danger variants',
    ...
    props: [
      {
        ...
        description: 'Dialog visibility and close callback',
      },
      {
        name: 'content',
        type: "{ title?: string; description?: string; variant?: 'info' | 'warning' | 'danger' }",
        default: "{ variant: 'info' }",
        description: 'Dialog content configuration',
      },
      {
        name: 'actions',
        type: '{ confirm?: { label?: string; onConfirm?: () => void; loading?: boolean }; cancel?: { label?: string; onCancel?: () => void } }',
        default:
          "{ confirm: { label: 'Confirm' }, cancel: { label: 'Cancel' } }",
        description: 'Confirm and cancel action configuration',
      },
      {
        name: 'children',
        type: 'ReactNode',
        description: 'Additional content rendered in the dialog body',
      },
    ],
    cssVars: [
      {
        name: '--azimuth-color-overlay',
        description: 'Backdrop overlay color',
      },
      {
        name: '--azimuth-color-surface',
        description: 'Dialog panel background',
      },
      { name: '--azimuth-color-text', description: 'Dialog text color' },
      {
        name: '--azimuth-color-primary',
        description: 'Confirm button background',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    props: [
      ...
      },
      {
        ...
        type: 'string',
        default: 'left',
        description: 'The side of the screen the drawer slides from',
      },
    ...
    cssVars: [
      ...
      {
        name: '--azimuth-color-surface',
        description: 'Drawer panel background',
      },
  ...
  },
  {
    name: 'DropdownList',
    description:
      'A dropdown select component with search, multiple selection, and keyboard navigation.',
    category: 'composite',
    features: [
    ...
    props: [
      ...
      },
      {
        ...
        default: '{ enabled: false }',
        description: 'Search configuration for the dropdown',
      },
      {
        name: 'disabled',
        type: 'boolean',
  ...
  },
  {
    name: 'EmptyState',
    description:
      'An empty state placeholder with icon, title, description, and optional action.',
    category: 'composite',
    features: [
      'Icon slot above title',
      'Title and description text',
      'Action slot for call-to-action',
    ...
    props: [
      {
        name: 'icon',
        type: 'ReactNode',
        description: 'Optional icon rendered above the title',
      },
      ...
      },
      {
        name: 'action',
        type: 'ReactNode',
        description: 'Action element rendered at the bottom',
      },
    ],
    cssVars: [
      { name: '--azimuth-color-text', description: 'Title text color' },
      {
        name: '--azimuth-color-text-muted',
  ...
  },
  {
    name: 'FanMenu',
    description:
      'An expandable radial menu that fans out options in a chosen direction.',
    category: 'composite',
    features: [
    ...
    props: [
      {
        name: 'options',
        type: 'FanMenuOption[]',
        description: 'Array of fan menu options',
      },
      {
        name: 'trigger',
        type: 'ReactNode',
      ...
      },
      {
        ...
        type: 'string',
        default: 'up',
        description: 'Direction the menu expands',
      },
      {
        name: 'gap',
        type: 'number',
        default: '8',
        description: 'Spacing between options in pixels',
      },
    ],
    cssVars: [
  ...
  },
  {
    ...
    props: [
      {
        ...
        description:
          'Callback fired when files are selected, dropped, or pasted',
      },
      {
        name: 'accept',
        type: 'string',
        description: 'Accepted file types string',
      },
      {
        name: 'multiple',
        type: 'boolean',
    ...
    cssVars: [
      ...
      {
        name: '--azimuth-color-surface',
        description: 'Upload area background',
      },
    ],
  },
  {
    name: 'Flyout',
    description:
      'A hover-triggered popover with configurable delay and positioning.',
    category: 'composite',
    features: [
      'Hover/focus trigger with configurable delays',
      'Four placement sides (top, bottom, left, right)',
      'Keyboard accessible via Enter/Escape',
    ...
    props: [
      {
        name: 'trigger',
        type: 'ReactNode',
        description: 'The element that triggers the flyout',
      },
      {
        name: 'content',
        type: 'ReactNode',
        description: 'The content rendered inside the flyout',
      },
      {
        name: 'side',
        type: 'string',
        default: 'bottom',
        description: 'Placement of the flyout relative to the trigger',
      },
      {
        name: 'openDelay',
        type: 'number',
  ...
  },
  {
    name: 'Form',
    description:
      'A form wrapper with automatic form data collection and field components.',
    category: 'composite',
    features: [
      'Form data collection via FormData API',
      'Field subcomponent with label, error, and help text',
    ...
    props: [
      {
        name: 'onSubmit',
        type: '(data: Record<string, FormDataEntryValue>) => void',
        description: 'Callback fired with form data keyed by field name',
      },
      {
        name: 'spacing',
        type: 'string',
  ...
  },
  {
    ...
    category: 'layout',
    features: [
      'Configurable column count (1-4 or auto-fit)',
      'CSS gap via spacing tokens',
      'Item alignment options',
      'Auto, highlight, and sidebar variants',
    ...
    props: [
      {
        ...
        type: 'number | string',
        default: 'auto',
        description: 'The number of columns or auto-fit behavior',
      },
      {
        name: 'gap',
        type: 'string',
        description: 'The spacing token for grid gap',
      },
      {
        name: 'align',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        default: 'auto',
        description: 'The visual variant of the grid',
      },
      {
        name: 'children',
        type: 'ReactNode',
    ...
    cssVars: [{ name: '--azimuth-space-lg', description: 'Default grid gap' }],
  },
  {
    name: 'Icon',
    description:
    ...
    features: [
      ...
      'Five size options (sm, md, lg, xl, xl2)',
      'Aria-hidden by default for decorative icons',
    ],
  ...
  },
  {
    ...
    category: 'primitive',
    features: [
      'Label with top/left/inner positioning',
  ...
  },
  {
    ...
    category: 'composite',
    features: [
      'Groups inputs without visual separation',
  ...
  },
  {
    name: 'Kbd',
    description:
      'A keyboard shortcut indicator styled as a inline keycap element.',
    category: 'composite',
    features: [
      'Inline keyboard shortcut styling',
      'Monospace font',
      'Subtle bordered appearance',
    ],
    variants: [],
    props: [
      {
        name: 'children',
        type: 'ReactNode',
        description: 'The keyboard shortcut text',
      },
    ],
    cssVars: [
  ...
  },
  {
    name: 'List',
    description:
      'An ordered or unordered list with configurable spacing and bullet markers.',
    category: 'composite',
    features: [
      'Ordered (ol) or unordered (ul) display',
      'Configurable spacing between items',
      'Bullet marker toggle',
      'Item subcomponent',
    ],
    variants: [],
    props: [
      ...
      },
      {
        ...
        type: 'boolean',
        default: 'false',
        description: 'Whether to show bullet markers',
      },
      {
        name: 'children',
        type: 'ReactNode',
  ...
  },
  {
    name: 'Loader',
    description:
      'A loading indicator with circular spinner or horizontal bar variants.',
    category: 'composite',
    features: [
      'Circle spinner and bar progress variants',
      'Three sizes (sm, md, lg)',
      'Accessible label with status role',
      'Custom label text',
    ],
    variants: ['circle', 'bar'],
    props: [
      {
        ...
        type: 'string',
        default: 'circle',
        description: 'The visual variant of the loader',
      },
      {
        name: 'size',
        type: 'string',
      ...
      },
      {
        name: 'label',
        type: 'string',
        description: 'Accessible label for the loader',
      },
    ],
    cssVars: [
      {
        name: '--azimuth-color-primary',
        description: 'Spinner/bar accent color',
      },
      { name: '--azimuth-fs-sm', description: 'Label font size' },
    ],
  },
  {
    name: 'LoginSignup',
    description:
      'A complete authentication form with login, signup, and password reset views.',
    category: 'composite',
    features: [
      'Login, signup, and password reset tabs',
      'External OAuth provider buttons',
    ...
    props: [
      {
        ...
        type: 'string',
        default: 'login',
        description: 'The initial view to display',
      },
      {
        name: 'auth',
        type: '{ onLogin?; onSignup?; onResetPassword? }',
        description: 'Authentication callbacks',
      },
      {
        name: 'social',
        type: '{ providers?: AuthProvider[]; onProviderAuth? }',
        description: 'Social provider config and callback',
      },
      {
        name: 'status',
        type: '{ loading?: boolean; error?: string }',
        description: 'Loading and error state',
      },
    ],
    cssVars: [
      {
        name: '--azimuth-color-primary',
        description: 'Submit button and active tab color',
      },
  ...
  },
  {
    name: 'Menu',
    description:
      'A dropdown menu with keyboard navigation, icons, and destructive action styling.',
    category: 'composite',
    features: [
      'Custom trigger element',
      'Keyboard navigation with arrow keys',
      'Item icons and danger styling',
      'Separator support',
      'Click-outside to close',
    ],
    variants: [],
  ...
  },
  {
    name: 'Modal',
    description:
      'A centered modal dialog with backdrop, title, subtitle, and footer slots.',
    category: 'composite',
    features: [
      'Centered overlay modal',
      'Title, subtitle, and footer slots',
    ...
    props: [
      {
        name: 'visible',
        type: '{ open: boolean; onClose: () => void }',
        description: 'Modal visibility and close callback',
      },
      {
        name: 'content',
        type: '{ title?; subtitle?; persistent?: boolean; blur?: string; size?: string }',
        description: 'Modal content configuration',
      },
      { name: 'footer', type: 'ReactNode', description: 'Footer content' },
      {
        name: 'children',
  ...
  },
  {
    name: 'Navbar',
    description:
      'A responsive navigation bar with logo, links, actions, and mobile drawer.',
    category: 'composite',
    features: [
      'Logo with link',
    ...
    props: [
      {
        name: 'branding',
        type: '{ logo?: ReactNode; href?: string }',
        description: 'Brand logo and link',
      },
      {
        name: 'nav',
        type: '{ items?: NavItem[]; activeKey?: string }',
        description: 'Navigation items and active key',
      },
      {
        name: 'responsive',
        type: '{ breakpoint?: number; position?: string }',
        description: 'Mobile responsive settings',
      },
      {
        name: 'actions',
        type: 'ReactNode',
        description: 'Action elements displayed on the right side',
      },
    ],
    cssVars: [
  ...
  },
  {
    name: 'PageLayout',
    description:
      'A full-page layout shell with top nav, sidebar, main content, and footer zones.',
    category: 'composite',
    features: [
      'Top navigation bar slot',
      'Sidebar with configurable width and position',
      'Main content area',
      'Footer slot',
      'Custom sidebar width via CSS variable',
    ],
    variants: [],
    props: [
      {
        name: 'sidebar',
        type: 'ReactNode',
        description: 'Sidebar content to render beside the main content',
      },
      {
        name: 'sidebarWidth',
        type: 'string',
        default: '260px',
        description: 'Width of the sidebar as a CSS value',
      },
      {
      ...
      },
      {
        name: 'footer',
        type: 'ReactNode',
        description: 'Footer content rendered at the bottom of the layout',
      },
      {
        name: 'children',
        type: 'ReactNode',
  ...
  },
  {
    name: 'Pagination',
    description:
      'A page navigation control with ellipsis collapsing and optional first/last buttons.',
    category: 'composite',
    features: [
      'Page range with sibling count',
      'Ellipsis collapsing for large page counts',
    ...
    props: [
      ...
      },
      {
        ...
        type: 'string',
        default: 'md',
        description: 'Size variant of the pagination component',
      },
    ],
    cssVars: [
      {
        name: '--azimuth-color-primary',
        description: 'Active page background',
      },
      {
        name: '--azimuth-color-on-primary',
        description: 'Active page text color',
      },
      {
        name: '--azimuth-color-surface',
        description: 'Page button background',
      },
      { name: '--azimuth-color-border', description: 'Button border color' },
    ],
  },
  {
    name: 'ProgressBar',
    description:
      'A progress indicator bar with determinate and indeterminate modes.',
    category: 'composite',
    features: [
      'Determinate and indeterminate modes',
      'Five color variants',
      'Three size variants',
      'ARIA progressbar role with value/text',
    ],
    ...
    cssVars: [
      {
        name: '--azimuth-color-primary',
        description: 'Primary progress fill color',
      },
      {
        name: '--azimuth-radius-full',
  ...
  },
  {
    name: 'ResizablePanel',
    description:
      'A split panel layout with draggable dividers for resizing child panels.',
    category: 'composite',
    features: [
      'Horizontal and vertical splitting',
      'Draggable dividers with keyboard support',
      'Configurable initial sizes',
    ...
    props: [
      {
        ...
        type: 'string',
        default: 'horizontal',
        description: 'Direction in which panels can be resized',
      },
      {
        name: 'defaultSizes',
        type: 'number[]',
      ...
      },
      {
        ...
        type: 'number',
        default: '50',
        description: 'Minimum size in pixels for each panel',
      },
      {
        name: 'children',
        type: 'ReactNode',
    ...
    props: [
      {
        name: 'onSearch',
        type: '(query: string) => void',
        description: 'Callback fired with the debounced search query',
      },
      {
        name: 'suggestions',
        type: 'string[]',
        description: 'Array of suggestion strings to display as the user types',
      },
      {
      ...
      },
      {
        ...
        type: 'number',
        default: '300',
        description: 'Debounce delay in milliseconds before firing onSearch',
      },
      {
        name: 'placeholder',
        type: 'string',
    ...
    cssVars: [
      {
        ...
        description: 'Search bar border color',
      },
  ...
  },
  {
    name: 'SectionView',
    description:
      'A collapsible section with a toggleable header and animated content reveal.',
    category: 'composite',
    features: [
      'Collapsible with chevron animation',
      'Controlled or uncontrolled expansion',
      'ARIA region with labelledby',
    ...
    props: [
      {
        name: 'title',
        type: 'string',
        description: 'Title text displayed in the section header',
      },
      {
        name: 'defaultExpanded',
        type: 'boolean',
      ...
      },
      {
        name: 'expanded',
        type: 'boolean',
        description: 'Whether the section is expanded (controlled)',
      },
      {
        name: 'onToggle',
  ...
  },
  {
    ...
    description:
      'A segmented control group for mutually exclusive options with keyboard navigation.',
    category: 'composite',
    features: [
      'Mutually exclusive selection (radio group)',
      'Keyboard navigation with arrow keys',
      'Icons in options',
      'Three sizes (sm, md, lg)',
      'Full width option',
    ...
    props: [
      ...
      },
      {
        ...
        type: 'string',
        default: 'md',
        description: 'Size variant of the segmented button',
      },
      {
        name: 'fullWidth',
        type: 'boolean',
        default: 'false',
        description: 'Whether the button group stretches to full width',
      },
    ],
    cssVars: [
      {
      ...
      {
        name: '--azimuth-color-border',
        description: 'Segmented button border',
      },
    ],
  },
  {
  ...
  },
  {
    name: 'Skeleton',
    description:
      'A loading placeholder component with text, circle, and rectangle variants.',
    category: 'composite',
    features: [
      'Text, circle, and rectangle shapes',
      'Custom width and height',
      'Multiple items via count prop',
    ...
    props: [
      ...
      },
      {
        name: 'width',
        type: 'string',
        description: 'Width of the skeleton as a CSS value',
      },
      {
        name: 'height',
        type: 'string',
        description: 'Height of the skeleton as a CSS value',
      },
      {
        name: 'count',
        type: 'number',
  ...
  },
  {
    name: 'Slider',
    description:
      'A range slider input with horizontal/vertical orientation and value display.',
    category: 'composite',
    features: [
      'Horizontal and vertical orientations',
      'Controlled or uncontrolled value',
    ...
    cssVars: [
      {
        name: '--azimuth-color-primary',
        description: 'Slider fill and thumb color',
      },
  ...
  },
  {
    name: 'SlideSheet',
    description:
      'A slide-in panel from any side of the screen with configurable size and snap points.',
    category: 'composite',
    features: [
    ...
    props: [
      ...
      },
      {
        name: 'onClose',
        type: '() => void',
        description: 'Callback fired when the sheet requests to close',
      },
      {
        name: 'side',
        type: 'string',
        default: 'bottom',
        description: 'Side of the screen from which the sheet slides in',
      },
      {
        name: 'title',
        type: 'string',
      ...
      },
      {
        name: 'height',
        type: 'string',
        description: 'Height or width of the sheet as a CSS value',
      },
      {
        name: 'snapPoints',
        type: 'string[]',
        description: 'Array of snap point sizes as CSS values',
      },
      {
        name: 'persistent',
        type: 'boolean',
        default: 'false',
        description: 'Whether clicking the overlay should close the sheet',
      },
      {
        name: 'children',
        type: 'ReactNode',
  ...
  },
  {
    ...
    props: [
      ...
      },
      {
        ...
        type: 'boolean',
        default: 'false',
        description: 'Whether stack items should wrap to the next line',
      },
      {
        name: 'children',
        type: 'ReactNode',
  ...
  },
  {
    name: 'Table',
    description:
      'A styled HTML table component with striped, bordered, and hoverable variants.',
    category: 'composite',
    features: [
      ...
      'Two size variants',
      'Subcomponents: Head, Body, Row, Cell, HeadCell',
    ],
    variants: [],
    props: [
      {
        ...
        type: 'boolean',
        default: 'false',
        description: 'Whether rows have alternating background colors',
      },
      {
        name: 'bordered',
        type: 'boolean',
        default: 'false',
        description: 'Whether the table has visible borders',
      },
      {
        name: 'hoverable',
        type: 'boolean',
        default: 'false',
        description: 'Whether rows are highlighted on hover',
      },
      {
        name: 'size',
        type: 'string',
    ...
    cssVars: [
      ...
      {
        name: '--azimuth-color-surface-hover',
        description: 'Hover row background',
      },
    ],
  },
  {
    name: 'Tabs',
    description:
      'A tabbed content switcher with underline, pills, and button variants.',
    category: 'composite',
    features: [
      'Three tab variants (underline, pills, buttons)',
      'Keyboard navigation with arrow keys',
    ...
    props: [
      {
        name: 'tabs',
        type: 'Array<{ id: string; label: string; content: ReactNode; disabled?: boolean }>',
      ...
      },
      {
        ...
        type: 'string',
        default: 'underline',
        description: 'Visual variant of the tab control',
      },
    ],
    cssVars: [
      {
      ...
      {
        name: '--azimuth-color-primary-subtle',
        description: 'Pills active background',
      },
  ...
  },
  {
    name: 'Tag',
    description:
      'A small label tag with color variants and optional remove button.',
    category: 'composite',
    features: [
      'Six color variants',
    ...
    props: [
      ...
      },
      {
        ...
        type: 'boolean',
        default: 'false',
        description: 'Whether the tag displays a remove button',
      },
      {
        name: 'onRemove',
        type: '() => void',
  ...
  },
  {
    ...
    category: 'primitive',
    features: [
      'Multiple font sizes from xs to h1',
      'Font weight options',
      'Text color variants',
      'Typography variants (display, heading, body, mono)',
      'Uppercase, truncate, and nowrap utilities',
      'Custom HTML element via as prop',
    ],
    ...
    props: [
      ...
      },
      {
        ...
        type: 'boolean',
        default: 'false',
        description: 'Whether to truncate text with an ellipsis',
      },
      {
        name: 'children',
        type: 'ReactNode',
  ...
  },
  {
    name: 'TextArea',
    description:
      'A multi-line text input with label, validation, and character count.',
    category: 'composite',
    features: [
    ...
    props: [
      ...
      },
      {
        name: 'maxLength',
        type: 'number',
        description: 'Maximum character length of the input',
      },
      {
        name: 'showCharCount',
        type: 'boolean',
        default: 'false',
        description: 'Whether to display a character count',
      },
      {
        name: 'size',
        type: 'string',
  ...
  },
  {
    name: 'TextBox',
    description:
      'A styled read-only text display container with plain and code variants.',
    category: 'composite',
    features: [
      'Plain and code display variants',
    ...
    props: [
      {
        ...
        type: 'string',
        default: 'plain',
        description: 'Display variant of the text box',
      },
      {
        name: 'children',
        type: 'ReactNode',
  ...
  },
  {
    ...
    category: 'primitive',
    features: [
      'Switch/checkbox appearance with role="switch"',
      'Label support',
      'Three sizes (sm, md, lg)',
  ...
  },
  {
    name: 'Tooltip',
    description:
      'A hover-triggered tooltip with configurable position and delay.',
    category: 'composite',
    features: [
  ...
  },
  {
    name: 'Toast',
    description:
      'A toast notification with variant styling, dismiss option, auto-dismiss timer, and expandable content.',
    category: 'composite',
    features: [
      'Multiple severity variants',
      'Dismissible with close button',
    ...
    props: [
      {
        name: 'content',
        type: "{ variant?: 'info' | 'success' | 'warning' | 'error'; title?: string; message?: string; icon?: ReactNode }",
        default: "{ variant: 'info' }",
        description: 'Toast content configuration',
      },
      {
        name: 'dismiss',
        type: '{ dismissible?: boolean; onDismiss?: () => void; autoDismiss?: number }',
        default: '{ dismissible: false }',
        description: 'Dismiss behavior configuration',
      },
      {
        name: 'expandable',
        type: 'boolean',
        default: 'false',
        description:
          'Whether the toast shows an expand button for children content',
      },
      {
        name: 'children',
        type: 'ReactNode',
        description: 'Additional content revealed when expanded',
      },
    ],
    cssVars: [
      { name: '--azimuth-color-border', description: 'Toast border color' },
      { name: '--azimuth-color-surface', description: 'Toast background' },
      { name: '--azimuth-shadow-md', description: 'Toast shadow' },
      { name: '--azimuth-color-text', description: 'Toast title color' },
      {
        name: '--azimuth-color-text-secondary',
        description: 'Toast message color',
      },
    ],
  },
  {
    name: 'TreeList',
    description:
      'A hierarchical tree view with expand/collapse, selection, and keyboard navigation.',
    category: 'composite',
    features: [
      'Nested node expansion/collapse',
      'Node selection with controlled mode',
    ...
    props: [
      ...
      },
      {
        name: 'defaultExpanded',
        type: 'string[]',
        description: 'IDs of nodes expanded by default',
      },
      {
        name: 'selectedId',
        type: 'string',
        description: 'ID of the currently selected node (controlled)',
      },
      {
        name: 'onSelect',
      ...
      },
      {
        ...
        description: 'Callback fired when a node is expanded or collapsed',
      },
      {
        name: 'showLines',
        type: 'boolean',
    ...
    cssVars: [
      ...
      {
        name: '--azimuth-color-primary-subtle',
        description: 'Selected node background',
      },
  ...
  },
  {
    ...
    description:
      'Combines breadcrumbs, page title, description, and action buttons in one component.',
    category: 'composite',
    features: [
    ...
    props: [
      ...
      },
      {
        name: 'actions',
        type: 'ReactNode',
        description: 'Action buttons rendered on the right of the title.',
      },
    ],
    cssVars: [
  ...
  },
  {
    name: 'ColorPicker',
    description:
      'A color picker with preset swatches and custom CSS color input.',
    category: 'composite',
    features: [
      'Preset swatch grid',
      'Custom color input',
      'Keyboard accessible swatches',
    ...
    props: [
      ...
      },
      {
        name: 'presets',
        type: 'string[]',
        description: 'Array of preset CSS color values.',
      },
      {
        name: 'showInput',
        type: 'boolean',
        default: 'true',
        description: 'Show custom color input field.',
      },
    ],
    cssVars: [
      {
        name: '--azimuth-radius-full',
        description: 'Swatch border radius (circular).',
      },
    ],
  },
  {
    name: 'Combobox',
    description:
      'An autocomplete input with filtered dropdown list following WAI-ARIA combobox pattern.',
    category: 'composite',
    features: [
    ...
    props: [
      ...
      },
      {
        name: 'options',
        type: 'ComboboxOption[]',
        description: 'Available options for filtering.',
      },
      {
        name: 'onSelect',
        type: '(value: string) => void',
    ...
    cssVars: [
      {
        name: '--azimuth-color-primary',
        description: 'Selected/highlighted option color.',
      },
  ...
  },
  {
    name: 'CommandPalette',
    description:
      'A ⌘K-style command palette modal with fuzzy search and keyboard navigation.',
    category: 'composite',
    features: [
      'Portal-based modal overlay',
      'Grouped results with search filtering',
    ...
    props: [
      ...
      },
      {
        name: 'onClose',
        type: '() => void',
        description: 'Callback when the palette requests close.',
      },
      {
        name: 'groups',
        type: 'CommandGroup[]',
  ...
  },
  {
    name: 'DiffViewer',
    description:
      'A line-by-line code diff viewer with unified and split view modes.',
    category: 'composite',
    features: [
      'Unified and split view modes',
      'Green/red highlighting for additions/removals',
      'Line numbers',
      'Change statistics header',
    ],
    variants: [],
    props: [
      ...
      },
      {
        ...
        type: 'boolean',
        default: 'false',
        description: 'Side-by-side view mode.',
      },
      {
        name: 'maxHeight',
        type: 'string',
        description: 'Max height of the diff area.',
      },
    ],
    cssVars: [
      {
        name: '--azimuth-color-success-bg',
        description: 'Added line background.',
      },
      {
        name: '--azimuth-color-error-bg',
  ...
  },
  {
    ...
    description:
      'A count badge positioned at the top-right of its child element.',
    category: 'composite',
    features: [
      'Count display with max overflow',
      'Dot mode (small indicator)',
      'Positioned at top-right of children',
      'Multiple color variants',
    ],
    ...
    props: [
      ...
      },
      {
        ...
        type: 'boolean',
        default: 'false',
        description: 'Show as small dot without count.',
      },
      {
        name: 'size',
        type: "'sm' | 'md'",
    ...
    cssVars: [
      ...
      {
        name: '--azimuth-radius-full',
        description: 'Badge border radius (pill).',
      },
    ],
  },
  {
    ...
    props: [
      ...
      },
      {
        name: 'value',
        type: 'string',
        description: 'Controlled value (digits).',
      },
      {
        name: 'onChange',
        type: '(value: string) => void',
      ...
      },
      {
        ...
        type: "'sm' | 'md' | 'lg'",
        default: "'md'",
        description: 'Size of digit boxes.',
      },
    ...
    cssVars: [
      {
        name: '--azimuth-color-primary',
        description: 'Focused/filled box border color.',
      },
      {
        name: '--azimuth-color-error-text',
  ...
  },
  {
    name: 'Rating',
    description:
      'A star rating widget with keyboard navigation and hover preview.',
    category: 'composite',
    features: [
      'Click to rate',
      'Hover preview',
  ...
  },
  {
    ...
    category: 'composite',
    features: [
      'Collapsed/expanded modes (60px/240px)',
    ...
    props: [
      ...
      },
      {
        name: 'onToggle',
        type: '() => void',
        description: 'Callback to toggle collapsed state.',
      },
      {
        name: 'header',
        type: 'ReactNode',
        description: 'Brand/logo area at the top.',
      },
      {
        name: 'footer',
        type: 'ReactNode',
  ...
  },
  {
    name: 'SplitButton',
    description:
      'A primary action button with a connected dropdown of alternative actions.',
    category: 'composite',
    features: [
      'Main action with dropdown toggle',
      'Dropdown with danger/disabled options',
      'Direction support (bottom/top)',
    ...
    props: [
      { name: 'label', type: 'string', description: 'Main button label.' },
      {
        name: 'onClick',
        type: '() => void',
        description: 'Callback for the main action.',
      },
      {
        name: 'options',
    ...
    cssVars: [
      {
        name: '--azimuth-color-primary',
        description: 'Primary variant background.',
      },
  ...
  },
  {
    name: 'Timeline',
    description:
      'A vertical chronological list of events with dots and connecting lines.',
    category: 'composite',
    features: [
      'Vertical layout with connecting line',
      'Circle dots for each event',
      'Optional date and icon per item',
      'Default and alternating variants',
    ],
  ...
  ,
  {
    name: 'Accordion',
    description:
      'A grouped set of collapsible sections where only one is open at a time.',
    category: 'composite',
    features: [
      'Single open section at a time',
      'Smooth expand animation',
      'Chevron rotate indicator',
      'Bordered and default variants',
    ...
    props: [
      {
        name: 'items',
        type: 'AccordionItem[]',
        description: 'Accordion section items.',
      },
      {
        name: 'defaultOpen',
        type: 'string',
        description: 'ID of the initially open item.',
      },
      {
        name: 'onToggle',
        type: '(id: string) => void',
        description: 'Callback when a section is toggled.',
      },
      {
        name: 'variant',
    ...
    cssVars: [
      ...
      {
        name: '--azimuth-color-primary',
        description: 'Active/expanded header color.',
      },
    ],
  },
  {
    ...
    features: [
      ...
      '12h and 24h formats',
      'Keyboard accessible stopwatch',
    ],
    variants: [],
    props: [
      {
        name: 'mode',
        type: "'clock' | 'countdown' | 'stopwatch'",
        default: "'clock'",
      ...
      },
      {
        name: 'targetDate',
        type: 'Date',
        description: 'Target date for countdown mode.',
      },
      {
        name: 'autoStart',
        type: 'boolean',
        default: 'true',
        description: 'Auto-start stopwatch.',
      },
      {
        name: 'size',
        type: "'sm' | 'md' | 'lg'",
    ...
    cssVars: [
      ...
      {
        name: '--azimuth-font-mono',
        description: 'Monospace font for digits.',
      },
    ],
  },
  {
    name: 'ErrorPage',
    description:
      'A generic error/status page layout for 404, 500, maintenance, etc.',
    category: 'composite',
    features: [
      'Centered layout with status code',
      'Customizable title and description',
      'Action button/link slot',
    ...
    props: [
      ...
      },
      {
        name: 'action',
        type: 'ReactNode',
        description: 'Recovery action element (button/link).',
      },
      {
        name: 'icon',
        type: 'ReactNode',
        description: 'Optional icon above status.',
      },
      {
        name: 'size',
        type: "'sm' | 'md' | 'lg'",
  ...
  },
  {
    name: 'ImageViewer',
    description:
      'A lightbox-style image viewer with modal overlay, navigation, and captions.',
    category: 'composite',
    features: [
      'Portal-based dark overlay',
      'Previous/next navigation',
    ...
    props: [
      ...
      },
      {
        name: 'onClose',
        type: '() => void',
        description: 'Callback when viewer closes.',
      },
      {
        name: 'initialIndex',
        type: 'number',
        default: '0',
        description: 'Index of initially displayed image.',
      },
      {
        name: 'showCaption',
        type: 'boolean',
        default: 'true',
        description: 'Show image caption.',
      },
      {
        name: 'showThumbnails',
        type: 'boolean',
    ...
    cssVars: [
      ...
      {
        name: '--azimuth-color-surface',
        description: 'Thumbnail border color.',
      },
    ],
  },
  {
    name: 'MapDisplay',
    description:
      'A map display with iframe embed support or styled placeholder grid.',
    category: 'composite',
    features: [
      'Iframe embed for real maps',
      'CSS placeholder grid when no URL',
      'Coordinate labels and compass rose',
    ...
    props: [
      {
        name: 'source',
        type: '{ src?: string; title?: string; interactive?: boolean }',
        description: 'Map source configuration',
      },
      {
        name: 'dimensions',
      ...
      {
        name: 'state',
        type: '{ zoom?: number; center?: object; markers?: MapMarker[] }',
        description: 'Map view state and markers',
      },
      {
        name: 'placeholder',
        type: 'ReactNode',
    ...
    cssVars: [
      {
        name: '--azimuth-color-border',
        description: 'Map border and grid line color.',
      },
  ...
  },
  {
    name: 'MediaPlayer',
    description:
      'A styled wrapper around HTML5 video and audio with custom controls.',
    category: 'composite',
    features: [
    ...
    props: [
      {
        name: 'source',
        type: '{ src: string; type?: string; poster?: string }',
        description: 'Media source, type, and poster',
      },
      {
        name: 'playback',
        type: '{ controls?: boolean; autoPlay?: boolean; loop?: boolean; muted?: boolean }',
        description: 'Playback behavior options',
      },
      {
        name: 'dimensions',
        type: '{ width?: string; height?: string }',
        description: 'Player dimensions',
      },
    ...
    cssVars: [
      {
        name: '--azimuth-color-primary',
        description: 'Seek bar accent color.',
      },
  ...
  },
  {
    name: 'SimpleChart',
    description:
      'SVG-based chart component for bar, line, and pie charts without external dependencies.',
    category: 'composite',
    features: [
